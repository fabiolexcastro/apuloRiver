...
ggsave(plot = glne_245, filename = './png/tasm/tmax_ftre_ssp245.png', units = 'in', width = 12, height = 9, dpi = 300)
ggsave(plot = glne_585, filename = './png/tasm/tmax_ftre_ssp585.png', units = 'in', width = 12, height = 9, dpi = 300)
cat('Done\n')
